...
return [
    'dashboard' => [
        ...
        'items' => [
            ...
            [
                'nombre' => 'Tablero Principal V2',
                'descripcion' => 'Seguimiento mensual con las ventas del dia actualizadas en vivo.',
                'url' => '/inicio-v2',
                'icono' => 'ri-dashboard-2-line',
                'categoria' => 'Principal',
                'tags' => ['inicio', 'tablero', 'indicadores', 'ventas', 'vivo'],
                'activo' => true,
            ],
            [
    ...
    'tecnologia' => [
        ...
        'items' => [
            ...
            [
                ...
                'descripcion' => '',
                'url' => '/tecnologia/monitoreo-terminales',
                'icono' => 'ri-computer-line',
                'categoria' => 'Monitoreo',
                'tags' => ['tecnologia', 'monitoreo', 'terminales'],
                'activo' => true,
            ],
            [
                'nombre' => 'Monitoreo agencias en plaza',
                'descripcion' => '',
                'url' => '/tecnologia/monitoreo-agencias-plaza',
                'icono' => 'ri-store-2-line',
                'categoria' => 'Monitoreo',
    ...
    'incentivos' => [
        ...
        'items' => [
            ...
            [
                'nombre' => 'Calculo de Incentivos',
                'descripcion' => 'Quinta version del reporte de incentivos con filtros por empresa y gestion administrativa.',
                'url' => '/incentivos/reporte-nuevo-incentivo-v5-view',
                'icono' => 'ri-flask-line',
                'categoria' => 'Reportes',
                'tags' => ['reporte', 'nuevo incentivo', 'v5', 'empresa'],
                'activo' => true,
            ],
            [
                'nombre' => 'Calculo de Incentivos V6 - Pruebas',
                'descripcion' => 'Version independiente para configurar tipos de pago diarios por terminal.',
                'url' => '/incentivos/reporte-nuevo-incentivo-v6-view',
                'icono' => 'ri-calendar-check-line',
                'categoria' => 'Reportes',
                'tags' => ['reporte', 'incentivos', 'v6', 'calendario', 'tipo de pago', 'terminal'],
                'activo' => true,
            ],
            [
    ...
    'gerencia' => [
        ...
        'items' => [
            ...
            [
                ...
                'url' => '/gerencia/seguimiento-agencia',
                'icono' => 'ri-focus-3-line',
                'categoria' => 'Ventas',
                'tags' => ['ventas', 'seguimiento', 'agencias', 'metas'],
                'activo' => true,
            ],
            [
                'nombre' => 'Gerencial',
            ...
            [
                ...
                'icono' => 'ri-funds-line',
                'categoria' => 'Rentabilidad',
                'tags' => ['gerencia', 'rentabilidad', 'agencias', 'ganancia'],
                'activo' => true,
            ],
            [
            ...
            [
                'nombre' => 'Ventas en Vivo',
                'descripcion' => 'Tablero de seguimiento diario con ventas por tipo y ranking top 10 de terminales, agencias y productos.',
                'url' => '/gerencia/ventas-en-vivo',
                'icono' => 'ri-pulse-line',
                'categoria' => 'Ventas',
                'tags' => ['ventas', 'seguimiento', 'tiempo real', 'top 10'],
                'activo' => true,
            ],
            [
                'nombre' => 'Ventas Online',
                'descripcion' => 'Analiza las ventas de productos no tradicionales por fecha, agencia y producto.',
                'url' => '/gerencia/ventas-online',
                'icono' => 'ri-shopping-bag-3-line',
                'categoria' => 'Ventas',
                'tags' => ['ventas', 'online', 'producto', 'no tradicionales'],
                'activo' => true,
            ],
        ],
    ],
