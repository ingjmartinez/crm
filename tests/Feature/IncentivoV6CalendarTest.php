...
class IncentivoV6CalendarTest extends TestCase
{
    ...
    public function test_v6_view_contains_calendar_without_changing_v5_view(): void
    {
        ...
        $this->assertStringContainsString('getCoordinatorCompanyLabel', $v6);
        $this->assertStringContainsString("companyValue === '168'", $v6);
        $this->assertStringContainsString("companyValue === '169'", $v6);
        $this->assertStringContainsString('Actualizar empresa', $v6);
