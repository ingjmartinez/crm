                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Nuevo Acuerdo</h4>
                    ...
                    <div class="col-lg-8 mx-auto">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Datos del acuerdo</h5>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('contabilidad.reportes.comisiones.acuerdos.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="cedula" class="form-control @error('cedula') is-invalid @enderror" value="{{ old('cedula') }}" inputmode="numeric" pattern="[0-9]{11}" maxlength="11" oninput="this.value=this.value.replace(/\D/g,'').slice(0, 11); this.setCustomValidity('')">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="telefono" class="form-control @error('telefono') is-invalid @enderror" value="{{ old('telefono') }}" inputmode="numeric" pattern="[0-9]{10}" maxlength="10" oninput="this.value=this.value.replace(/\D/g,'').slice(0, 10); this.setCustomValidity('')">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="porcentaje" class="form-control @error('porcentaje') is-invalid @enderror" value="{{ old('porcentaje', '0.00') }}" min="0" max="100" step="0.01" required>
