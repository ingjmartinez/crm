            ...
            <div class="container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-md-9 d-flex gap-2 flex-wrap">
                                        ...
                                        <button id="btnCalcularPromedioHistorico" class="btn btn-outline-dark" title="Calcula el promedio de venta de los ultimos 3 meses completos y lo guarda. No se recalcula solo.">
                                            <i class="ri-calculator-line me-1"></i>Calcular Promedio (3 meses)
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 d-none" id="seccionResultados">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <p class="text-uppercase fw-medium text-muted mb-0">Ventas de Productos</p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-end justify-content-between mt-4">
                                            <div>
                                                <h3 class="fs-28 fw-semibold mb-0" id="cardMontoTotal">RD$ 0.00</h3>
                                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-xl-6">
                                <div class="card card-animate mb-0 h-100 border border-primary border-opacity-25">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <p class="text-uppercase fw-medium text-muted mb-0">Ventas Tradicionales</p>
                                            <span class="badge bg-primary-subtle text-primary" id="cardPorcentajeTradicional">0.0% del total</span>
                                        </div>
                                        <div class="mt-3">
                                            <h3 class="fs-32 fw-semibold mb-0 text-primary" id="cardMontoTradicional">RD$ 0.00</h3>
                                            <small class="text-muted fw-bold d-block" id="cardDetalleTradicional">0 agencias · Promedio: RD$ 0.00</small>
                                        </div>
                                        <hr class="my-3">
                                        <div class="d-flex align-items-center justify-content-between gap-3">
                                            <div>
                                                <small class="text-uppercase text-muted d-block">Promedio venta diario (ultimos 3 meses)</small>
                                                <h5 class="fw-semibold mb-0 text-primary" id="cardPromedioHistoricoTradicional">Sin calcular</h5>
                                                <small class="text-muted d-block" id="cardBasePromedioTradicional"></small>
                                                <small class="fw-semibold d-block mt-1" id="cardBrechaPromedioTradicional"></small>
                                            </div>
                                            <div class="promedio-progress" id="chartPromedioTradicional"
                                                style="--progress: 0; --progress-color: #405189"
                                                role="img" aria-label="Cumplimiento tradicional: 0%">
                                                <span class="promedio-progress-value" id="chartPromedioTradicionalValor">0%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card card-animate mb-0 h-100 border border-warning border-opacity-25">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <p class="text-uppercase fw-medium text-muted mb-0">Ventas No Tradicionales</p>
                                            <span class="badge bg-warning-subtle text-warning" id="cardPorcentajeNoTradicional">0.0% del total</span>
                                        </div>
                                        <div class="mt-3">
                                            <h3 class="fs-32 fw-semibold mb-0 text-warning" id="cardMontoNoTradicional">RD$ 0.00</h3>
                                            <small class="text-muted fw-bold d-block" id="cardDetalleNoTradicional">0 agencias · Promedio: RD$ 0.00</small>
                                        </div>
                                        <hr class="my-3">
                                        <div class="d-flex align-items-center justify-content-between gap-3">
                                            <div>
                                                <small class="text-uppercase text-muted d-block">Promedio venta diario (ultimos 3 meses)</small>
                                                <h5 class="fw-semibold mb-0 text-warning" id="cardPromedioHistoricoNoTradicional">Sin calcular</h5>
                                                <small class="text-muted d-block" id="cardBasePromedioNoTradicional"></small>
                                                <small class="fw-semibold d-block mt-1" id="cardBrechaPromedioNoTradicional"></small>
                                            </div>
                                            <div class="promedio-progress" id="chartPromedioNoTradicional"
                                                style="--progress: 0; --progress-color: #f7b84b"
                                                role="img" aria-label="Cumplimiento no tradicional: 0%">
                                                <span class="promedio-progress-value" id="chartPromedioNoTradicionalValor">0%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <small class="text-muted d-none" id="labelVentasSinClasificar"></small>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card h-100">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="card-title mb-0">Productos Tradicionales</h5>
                                        <span class="badge bg-primary-subtle text-primary fs-12" id="labelFechaAplicada"></span>
                                    </div>
                                    <div class="card-body">
                                        <table id="tableProductosTradicional"
                            ...
                            <div class="col-xl-6">
                                <div class="card h-100">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        <h5 class="card-title mb-0">Productos No Tradicionales</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="tableProductosNoTradicional"
                                            class="table table-bordered dt-responsive nowrap table-striped align-middle"
                                            style="width:100%">
                                            <thead>
                                                <tr>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const cardMontoTradicional = document.getElementById('cardMontoTradicional');
    const cardMontoNoTradicional = document.getElementById('cardMontoNoTradicional');
    const cardPorcentajeTradicional = document.getElementById('cardPorcentajeTradicional');
    const cardPorcentajeNoTradicional = document.getElementById('cardPorcentajeNoTradicional');
    const cardDetalleTradicional = document.getElementById('cardDetalleTradicional');
    const cardDetalleNoTradicional = document.getElementById('cardDetalleNoTradicional');
    const labelVentasSinClasificar = document.getElementById('labelVentasSinClasificar');
    const cardPromedioHistoricoTradicional = document.getElementById('cardPromedioHistoricoTradicional');
    const cardPromedioHistoricoNoTradicional = document.getElementById('cardPromedioHistoricoNoTradicional');
    const cardBasePromedioTradicional = document.getElementById('cardBasePromedioTradicional');
    const cardBasePromedioNoTradicional = document.getElementById('cardBasePromedioNoTradicional');
    const cardBrechaPromedioTradicional = document.getElementById('cardBrechaPromedioTradicional');
    const cardBrechaPromedioNoTradicional = document.getElementById('cardBrechaPromedioNoTradicional');
    const chartPromedioTradicional = document.getElementById('chartPromedioTradicional');
    const chartPromedioNoTradicional = document.getElementById('chartPromedioNoTradicional');
    const chartPromedioTradicionalValor = document.getElementById('chartPromedioTradicionalValor');
    const chartPromedioNoTradicionalValor = document.getElementById('chartPromedioNoTradicionalValor');
    const btnCalcularPromedioHistorico = document.getElementById('btnCalcularPromedioHistorico');
    ...
    let dtProductosTradicional   = null;
    let dtProductosNoTradicional = null;
    let dtAgencias       = null;
    let dtCiudades       = null;
    let dtRutas          = null;
    ...
    let promediosHistoricos = [];
    let ventasActualesPorTipo = { tradicional: 0, no_tradicional: 0 };

    const formatMoney = (value) => Number(value ?? 0).toLocaleString('es-DO', {
    ...
    const destroyTables = () => {
        if (dtProductosTradicional) {
            dtProductosTradicional.destroy();
            dtProductosTradicional = null;
        }
        if (dtProductosNoTradicional) {
            dtProductosNoTradicional.destroy();
            dtProductosNoTradicional = null;
        }
        if (dtAgencias) {
            dtAgencias.destroy();
            dtAgencias = null;
        ...
        document.querySelector('#tableProductosTradicional tbody').innerHTML = '';
        document.querySelector('#tableProductosNoTradicional tbody').innerHTML = '';
        ...
        cardMontoTradicional.textContent = 'RD$ 0.00';
        cardMontoNoTradicional.textContent = 'RD$ 0.00';
        cardPorcentajeTradicional.textContent = '0.0% del total';
        cardPorcentajeNoTradicional.textContent = '0.0% del total';
        cardDetalleTradicional.textContent = '0 agencias · Promedio: RD$ 0.00';
        cardDetalleNoTradicional.textContent = '0 agencias · Promedio: RD$ 0.00';
        labelVentasSinClasificar.textContent = '';
        labelVentasSinClasificar.classList.add('d-none');
    ...
    const clearMainTables = () => {
        if (dtProductosTradicional) { dtProductosTradicional.destroy(); dtProductosTradicional = null; }
        if (dtProductosNoTradicional) { dtProductosNoTradicional.destroy(); dtProductosNoTradicional = null; }
    ...
    const crearResumenPorTipo = () => ({
        tradicional: { monto: 0, agencias: new Set() },
        no_tradicional: { monto: 0, agencias: new Set() },
        otros: { monto: 0, agencias: new Set() },
    });

    const normalizarTipoCategoria = (valor) => {
        const tipo = (valor ?? '').toString().trim().toLowerCase();
        if (tipo === 'tradicional') return 'tradicional';
        if (tipo === 'no_tradicional' || tipo === 'no tradicional') return 'no_tradicional';
        return 'otros';
    };

    const acumularPorTipo = (resumen, item, agencia, monto) => {
        const tipo = normalizarTipoCategoria(item.tipo_categoria ?? item.tipo);
        resumen[tipo].monto += monto;
        resumen[tipo].agencias.add(agencia);
    };

    const pintarPromedioHistorico = (promedios) => {
        const lista = Array.isArray(promedios) ? promedios : [];
        promediosHistoricos = lista;
        const porTipo = tipo => lista.find(item => item.tipo_categoria === tipo) ?? null;

        const pintar = (registro, elMonto, elBase) => {
            elMonto.textContent = registro ? `RD$ ${formatMoney(registro.monto_promedio)}` : 'Sin calcular';
            elBase.textContent = registro
                ? `Total de los meses dividido entre ${Number(registro.dias_promediados || 0)} dias calendario`
                : '';
        };

        pintar(porTipo('tradicional'), cardPromedioHistoricoTradicional, cardBasePromedioTradicional);
        pintar(porTipo('no_tradicional'), cardPromedioHistoricoNoTradicional, cardBasePromedioNoTradicional);
        actualizarGraficosCumplimientoPromedio();
    };

    const actualizarGraficoCumplimiento = (tipo, chart, valor, brecha) => {
        const promedio = Number(promediosHistoricos.find(item => item.tipo_categoria === tipo)?.monto_promedio || 0);
        const venta = Number(ventasActualesPorTipo[tipo] || 0);
        const porcentajeReal = promedio > 0 ? (venta / promedio) * 100 : 0;
        const porcentajeVisual = Math.min(100, Math.max(0, porcentajeReal));
        const faltante = Math.max(0, promedio - venta);

        chart.style.setProperty('--progress', porcentajeVisual.toFixed(2));
        chart.setAttribute('aria-label', `Cumplimiento: ${porcentajeReal.toFixed(1)}%`);
        valor.textContent = `${porcentajeVisual.toFixed(0)}%`;

        if (promedio <= 0) {
            brecha.textContent = 'Calcula el promedio para medir cumplimiento';
            brecha.className = 'text-muted fw-semibold d-block mt-1';
            return;
        }

        brecha.textContent = faltante > 0
            ? `Faltan RD$ ${formatMoney(faltante)} para llegar al 100%`
            : `Meta diaria superada por RD$ ${formatMoney(venta - promedio)}`;
        brecha.className = `${faltante > 0 ? 'text-danger' : 'text-success'} fw-semibold d-block mt-1`;
    };

    const actualizarGraficosCumplimientoPromedio = () => {
        actualizarGraficoCumplimiento(
            'tradicional',
            chartPromedioTradicional,
            chartPromedioTradicionalValor,
            cardBrechaPromedioTradicional
        );
        actualizarGraficoCumplimiento(
            'no_tradicional',
            chartPromedioNoTradicional,
            chartPromedioNoTradicionalValor,
            cardBrechaPromedioNoTradicional
        );
    };

    const cargarPromedioHistoricoGuardado = () => {
        fetchJson('{{ route('gerencia.ventas-online.promedio-historico.show') }}')
            .then(data => pintarPromedioHistorico(data.promedios))
            .catch(() => {
                // Si falla la carga inicial simplemente se deja "Sin calcular"; el usuario puede pulsar el botón.
            });
    };

    const pintarCardsPorTipo = (resumen, totalVendido) => {
        const porcentaje = (monto) => (totalVendido > 0 ? (monto / totalVendido) * 100 : 0).toFixed(1);
        const detalle = ({ monto, agencias }) => {
            const cantidad = agencias.size;
            const promedio = cantidad > 0 ? monto / cantidad : 0;
            return `Agencias: ${cantidad.toLocaleString('es-DO')} · Promedio: RD$ ${formatMoney(promedio)}`;
        };

        cardMontoTradicional.textContent = `RD$ ${formatMoney(resumen.tradicional.monto)}`;
        cardMontoNoTradicional.textContent = `RD$ ${formatMoney(resumen.no_tradicional.monto)}`;
        ventasActualesPorTipo = {
            tradicional: resumen.tradicional.monto,
            no_tradicional: resumen.no_tradicional.monto,
        };
        actualizarGraficosCumplimientoPromedio();
        cardPorcentajeTradicional.textContent = `${porcentaje(resumen.tradicional.monto)}% del total`;
        cardPorcentajeNoTradicional.textContent = `${porcentaje(resumen.no_tradicional.monto)}% del total`;
        cardDetalleTradicional.textContent = detalle(resumen.tradicional);
        cardDetalleNoTradicional.textContent = detalle(resumen.no_tradicional);

        const sinClasificar = resumen.otros.monto;
        labelVentasSinClasificar.textContent = sinClasificar > 0
            ? `Productos sin clasificar en el catálogo de juegos: RD$ ${formatMoney(sinClasificar)}`
            : '';
        labelVentasSinClasificar.classList.toggle('d-none', sinClasificar <= 0);
    };

    const crearResumenProductoPorTipo = () => ({
        tradicional: new Map(),
        no_tradicional: new Map(),
    });

    const acumularProductoPorTipo = (resumenProductoPorTipo, item, descripcion, monto) => {
        const tipo = normalizarTipoCategoria(item.tipo_categoria ?? item.tipo);
        if (tipo !== 'tradicional' && tipo !== 'no_tradicional') return;
    ...
    const renderResumen = (ventas) => {
        ...
        (ventas ?? []).forEach(item => {
            ...
            acumularProductoPorTipo(resumenProductoPorTipo, item, descripcion, monto);
            ...
            acumularPorTipo(resumenPorTipo, item, agencia, monto);
            totalVendido += monto;
        });
        ...
        let productosTradicionalesOrdenados = [...resumenProductoPorTipo.tradicional.entries()]
            .sort((a, b) => b[1] - a[1]);
        let productosNoTradicionalesOrdenados = [...resumenProductoPorTipo.no_tradicional.entries()]
            .sort((a, b) => b[1] - a[1]);
        ...
        if (filtroCumplimientoAgencia !== 'todos') {
            const resumenProductoPorTipoFiltrado = crearResumenProductoPorTipo();
            const resumenCiudadFiltrado = new Map();
            const resumenRutaFiltrado = new Map();
            resumenPorTipo = crearResumenPorTipo();
            (ventas ?? []).forEach(item => {
                const agencia = (item.agencia_id ?? 'SIN AGENCIA').toString().trim() || 'SIN AGENCIA';
                ...
                const ruta = (item.ruta ?? 'SIN RUTA').toString().trim() || 'SIN RUTA';
                const monto = Number(item.monto ?? 0);
                acumularProductoPorTipo(resumenProductoPorTipoFiltrado, item, descripcion, monto);
            ...
            productosTradicionalesOrdenados = [...resumenProductoPorTipoFiltrado.tradicional.entries()].sort((a, b) => b[1] - a[1]);
            productosNoTradicionalesOrdenados = [...resumenProductoPorTipoFiltrado.no_tradicional.entries()].sort((a, b) => b[1] - a[1]);
        ...
        const hayResumenAgenciasBackend = resumenEstadoAgencias.con_ventas > 0 || resumenEstadoAgencias.sin_ventas > 0;
        ...
        cardAgenciasSinVentas.textContent = (hayResumenAgenciasBackend ? resumenEstadoAgencias.sin_ventas : 0).toLocaleString('es-DO');

        pintarCardsPorTipo(resumenPorTipo, totalVendido);

        resumenAgenciaVisibleActual = new Map(agenciasFiltradas);

        const tbodyProductosTradicional = document.querySelector('#tableProductosTradicional tbody');
        productosTradicionalesOrdenados.forEach(([descripcion, total]) => {
            const tr = document.createElement('tr');
            tr.innerHTML = `
                <td>${descripcion}</td>
                <td>${formatMoney(total)}</td>
            `;
            tbodyProductosTradicional.appendChild(tr);
        });

        const tbodyProductosNoTradicional = document.querySelector('#tableProductosNoTradicional tbody');
        productosNoTradicionalesOrdenados.forEach(([descripcion, total]) => {
            const tr = document.createElement('tr');
            tr.innerHTML = `
                <td>${descripcion}</td>
                <td>${formatMoney(total)}</td>
            `;
            tbodyProductosNoTradicional.appendChild(tr);
        });
        ...
        dtProductosTradicional = $('#tableProductosTradicional').DataTable({
            destroy: true,
            responsive: true,
            language: {
                url: '/json/es-DO.json',
        ...
        dtProductosNoTradicional = $('#tableProductosNoTradicional').DataTable({
            destroy: true,
            responsive: true,
            language: {
                url: '/json/es-DO.json',
    ...
    updateFiltroLabel();
    updateModalFiltroLabel();
    cargarPromedioHistoricoGuardado();

    // --- Calcular Promedio (3 meses), no se recalcula solo: solo corre cuando se pulsa el boton ---
    btnCalcularPromedioHistorico.addEventListener('click', function () {
        Swal.fire({
            title: '¿Calcular promedio de los ultimos 3 meses?',
            text: 'Esto reemplaza el promedio guardado actualmente. El resultado se queda fijo hasta la proxima vez que lo calcules.',
            icon: 'question',
            ...
            btnCalcularPromedioHistorico.disabled = true;
            Swal.fire({
                title: 'Calculando...',
                allowOutsideClick: false,
                allowEscapeKey: false,
            ...
            fetchJson('{{ route('gerencia.ventas-online.promedio-historico.calcular') }}', {
                method: 'POST',
                headers: { 'X-CSRF-TOKEN': APP_CSRF },
            })
                .then(data => {
                    Swal.close();
                    btnCalcularPromedioHistorico.disabled = false;
                    pintarPromedioHistorico(data.promedios);
                    Swal.fire({ title: 'Listo', text: 'Promedio calculado y guardado.', icon: 'success', timer: 1600, showConfirmButton: false });
                })
                .catch(err => {
                    Swal.close();
                    btnCalcularPromedioHistorico.disabled = false;
