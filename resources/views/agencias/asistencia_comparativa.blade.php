                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Asistencia Comparativa (API)</h4>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="alert alert-info mb-3" id="resumenBox">
                                    Selecciona una fecha para consultar asistencias desde APIs.
                                </div>
...
<script>
    ...
    async function solicitarCorreoYEnviar(row) {
        ...
        const estadoNormalizado = (row?.estado_key === 'cumple' || String(row?.estado || '').toUpperCase() === 'CUMPLE')
            ? 'CUMPLE'
            : 'INCUMPLE';
    ...
    $(document).ready(function() {
        table = $('#tableIncumplimientos').DataTable({
            ...
            columns: [
                ...
                { data: 'salida_pm_programada', defaultContent: '-', className: 'text-center', render: function(data) { return data || '-'; }},
