                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Editar Ruta</h4>
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('ruta.update', $registro->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="nombre_ruta" class="form-control @error('nombre_ruta') is-invalid @enderror" value="{{ old('nombre_ruta', $registro->nombre_ruta) }}" oninput="this.value = this.value.toUpperCase()" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="operador_ruta_id" class="form-select @error('operador_ruta_id') is-invalid @enderror" required>
                                                ...
                                                @foreach (($operadores ?? []) as $operador)
                                                    <option value="{{ $operador->id }}" @selected((string) old('operador_ruta_id', $registro->operador_ruta_id) === (string) $operador->id)>
